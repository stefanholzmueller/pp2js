(function () {
    ...
    test("count for success and failure", function () {
        var result = calculator.calculatePartitioned({ attributes: [12, 12, 12], skill: 4, difficulty: 0, options: { minimumQuality: true } });
    ...
    test("one more partition without minimumQuality", function () {
        var result = calculator.calculatePartitioned({ attributes: [12, 12, 12], skill: 4, difficulty: 0, options: { minimumQuality: false } });
