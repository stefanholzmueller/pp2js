(function () {
    ...
    test("eight difficulties", function () {
        var data = chart.getBarData({ attributes: [12, 12, 12], skill: 4, difficulty: 3, options: { minimumQuality: true }});
        equal(data.length, 2);
    ...
    test("seven difficulties", function () {
        var data = chart.getBarData({ attributes: [12, 12, 12], skill: 4, difficulty: 0, options: { minimumQuality: true }});
        equal(data.length, 2);
    ...
    test("colors", function () {
        var data = chart.getBarData({ attributes: [12, 12, 12], skill: 4, difficulty: -13, options: { minimumQuality: true }});
